...
ask = input("choose default destination files ??['D:\\file_list_store.txt' and 'D:\\directory_list_store.txt'] (y/n) : ")
if ask == 'y':
    filepath = 'D:\\file_list_store.txt'
    dirpath = 'D:\\directory_list_store.txt'
else:
    filepath = input("Enter the directory path to save the file list: ")
    dirpath = input("Enter the directory path to save the directory list: ")
try:
    os.chdir(dirinput)
    filehandle = open(filepath,'w')
    dirhandle = open(dirpath,'w')
