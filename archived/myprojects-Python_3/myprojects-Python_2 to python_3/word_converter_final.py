...
target_word = input("Enter the ending word : ")
repeat = int(input("Enter the layer number to be generated : "))
filename = input("Enter the file adress to store the result : ")
...
try:
    ...
    location = input("Please enter a dictionary file location :")
    f = open(location,'r')
...
for i in range(repeat):
    ...
    init_dict = new_dict
    print(len(wordlist), end=' ')#remaining words printing
