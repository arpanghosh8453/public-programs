...
class Show_data(QtWidgets.QWidget):
    ...
    def saveFile(self):
        ...
        if fileName:
            try:
                ui.data_.to_csv(fileName,index=False,sep='\t')
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(1079, 635)
        Dialog.setFixedSize(1079, 652)
        ...
        self.label_2.setGeometry(QtCore.QRect(480, 10, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.line = QtWidgets.QFrame(Dialog)
        self.line.setGeometry(QtCore.QRect(10, 120, 1021, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.calendarWidget = QtWidgets.QCalendarWidget(Dialog)
        self.calendarWidget.setGeometry(QtCore.QRect(20, 150, 392, 236))
        ...
        self.calendarWidget.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.India))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 420, 391, 161))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(430, 420, 221, 141))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_7.setGeometry(QtCore.QRect(830, 150, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.pushButton_3 = QtWidgets.QPushButton(Dialog)
        self.pushButton_3.setGeometry(QtCore.QRect(710, 400, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(890, 430, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(710, 480, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(710, 560, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.checkBox.setGeometry(QtCore.QRect(920, 500, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(920, 540, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.checkBox_3.setGeometry(QtCore.QRect(920, 580, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox_3.setFont(font)
        self.checkBox_3.setObjectName("checkBox_3")
        self.textBrowser = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser.setGeometry(QtCore.QRect(690, 180, 361, 192))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.textBrowser.setFont(font)
        self.textBrowser.setObjectName("textBrowser")
        self.textBrowser_2 = QtWidgets.QTextBrowser(Dialog)
        self.textBrowser_2.setGeometry(QtCore.QRect(130, 50, 531, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.textBrowser_2.setFont(font)
        self.textBrowser_2.setObjectName("textBrowser_2")
        self.checkBox_4 = QtWidgets.QCheckBox(Dialog)
        self.checkBox_4.setGeometry(QtCore.QRect(930, 400, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(880,80,111,41))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.checkBox_5.setGeometry(QtCore.QRect(750,90,121,21))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Bank Balance Analyser"))
        ...
        self.label_2.setText(_translate("Dialog", "© Arpan Ghosh"))
        ...
        self.checkBox_5.setText(_translate("Dialog", "German Bank"))
    ...
    def find_default(self):
        try:
            ...
            data = pandas.read_csv(file_path,sep = '\t',skiprows=skip_r,skipfooter=skip_f,engine='python')
    ...
    def calculate(self):
        ...
        try:
            data = pandas.read_csv(self.filename[0],sep = '\t',skiprows=skip_r,skipfooter=skip_f,engine='python')
            try:
                data['Debit'] = data['        Debit']
            except KeyError:
