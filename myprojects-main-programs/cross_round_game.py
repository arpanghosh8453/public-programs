...
def changeinput1(l,step):
    while True:
        try:
            change1 = int(raw_input("Enter a proper place number to print 'X':"))
...
def changeinput2(l,step):
    while True:
        try:
            change2 = int(raw_input("Enter a proper place number to print '0':"))
...
def WonPlayer(l,firstPlayer,secondPlayer):
    if l[0] == l[1] == l[2] == 'X' or l[0] == l[1] == l[2] == '0':
        ...
        return False,'None'
def PlayerInput():
    firstPlayer = raw_input("Enter the first player name(team of 'X') :")
    secondPlayer = raw_input("Enter the second player name(team of '0') :")
...
def playAgain():
    while True:
        try:
            print '\n'
            ifplay = int(raw_input('Enter 1 to play again and 0 to exit ... :'))
            if ifplay == 0:
                return False
            elif ifplay == 1:
                return True
