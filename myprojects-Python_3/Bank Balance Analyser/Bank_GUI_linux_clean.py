...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(870, 560, 200, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def get_file_name(self):
        self.filename = QFileDialog.getOpenFileName(None, 'Open file', expanduser('~'),"All files (*.*)",options=QFileDialog.DontUseNativeDialog)
    ...
    def convert_german(self):
        ...
        try:
            filename_1 = QFileDialog.getOpenFileName(None, 'Open file', expanduser('~'),"All files (*.* )",options=QFileDialog.DontUseNativeDialog)[0]
            if filename_1:
