...
info += "Maximum Credit of "+str(Max_C['Credit'].to_list()[0])+" was caused on "+str(Max_C['Value Date'].to_list()[0])+" by reference "+str(Max_C['Ref No./Cheque No.'].to_list()[0])+" because "+str(Max_C['Description'].to_list()[0])+' making balance '+str(Max_C['Balance'].to_list()[0])+'\n'+"Maximum Debit of "+str(Max_D['Debit'].to_list()[0])+" was caused on "+str(Max_D['Value Date'].to_list()[0])
