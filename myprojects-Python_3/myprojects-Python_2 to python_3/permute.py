...
string = input("Enter the string to pelmute :")
length = int(input("Enter the length of resulting permutions :"))
repeat = input("Repeat the values for permutation ? (y/n) :")
always_occures = eval(input("Enter values that must occure as strings in a list (i.e.>> ['ab','dc'...] ,if nothing to give, Enter : []) :"))
filename = input("Enter the full file path (i.e. >> D:/Permutation_results.txt) : ")
